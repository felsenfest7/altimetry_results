...
#MARMARİS ALES
#Verinin okunması
ales_jason2 = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/MARMARİS/MARMARİS_VERİLER/JASON2/JASON2_DATA/*.nc")
ales_jason3 = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/MARMARİS/MARMARİS_VERİLER/JASON3/JASON3_DATA/*.nc")
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 24.88]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 25.25]
...
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Marmaris Aylık Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf(filtered_idw_ales)

#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "MARMARİS", "marmaris_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Marmaris", "marmaris", "ales")
