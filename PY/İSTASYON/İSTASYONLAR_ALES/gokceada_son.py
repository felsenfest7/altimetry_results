...
ales_jason2 = af.index_sec(ales_jason2, 8)
ales_jason3 = af.index_sec(ales_jason3, 8)

#Veriye filter uygulanması
ales_jason2 = af.filter_ales_05(ales_jason2)    # 278 veriden 262 tanesi kullanılabiliyor
ales_jason3 = af.filter_ales_05(ales_jason3)    # 93 veriden 87 tanesi kullanılabiliyor
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 40.30]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 40.57]
...
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Gökçeada Aylık Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf(filtered_idw_ales)

#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "GOKCEADA", "gokceada_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Gökçeada", "gokceada", "ales")
