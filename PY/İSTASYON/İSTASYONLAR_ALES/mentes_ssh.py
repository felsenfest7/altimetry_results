...
#filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 39.50]
#filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 39.20]
...
#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "MENTES", "mentes_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Menteş", "mentes", "ales")
