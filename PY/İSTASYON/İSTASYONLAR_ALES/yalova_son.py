...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 37.40]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 37.70]
...
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Yalova Aylık Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf(filtered_idw_ales)

#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "YALOVA", "yalova_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Yalova", "yalova", "ales")
