...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 27.20]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 27.50]
...
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Bozyazı Aylık Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf(filtered_idw_ales)

#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "BOZYAZI", "bozyazi_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Bozyazı", "bozyazı", "ales")
