...
#ERDEL ALES
#Verinin okunması
ales_jason2 = af.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ERDEK/ERDEK_VERİLER/JASON2/JASON2_DATA/*.nc")
ales_jason3 = af.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/ERDEK/ERDEK_VERİLER/JASON3/JASON3_DATA/*.nc")
...
ort_koordinatlar_ales = af.ort_koord(hesaba_girecek_veriler, 7)
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 38.55]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 38.90]
...
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Erdek Aylık Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf(filtered_idw_ales)

#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "ERDEK", "erdek_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Erdek", "erdek", "ales")
