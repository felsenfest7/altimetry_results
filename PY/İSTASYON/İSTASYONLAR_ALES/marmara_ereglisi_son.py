...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 37.95]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 38.26]
...
#Excele aktarılması
#wish_table = af.df2excel3(wish, "ALES3", "MARMARA_EREGLİSİ", "marmara_ereglisi_ssh_weight")

#print(boylam_ales, enlem_ales)

haa = ha.harmonik_analiz2(wish, "Marmara Ereğlisi", "marmara_ereglisi", "ales")
